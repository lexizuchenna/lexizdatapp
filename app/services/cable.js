...
function data() {
  ...
  const [currentPack, setCurrentPack] = useState([
    { label: "Select Package", value: "null" },
  ]);

  const handlePayCable = (biller, pack, iuc_number, number) => {
    console.log(biller, pack, iuc_number, number);
  };
  return (
    <SafeAreaView
      style={{
              ...
              >
                <SelectInput
                  ...
                  onChangeSelect={(value) => {
                    setBiller(value);
                    setPack(value);
                    setCurrentPack(changePack(value));
                  }}
                  items={billers}
                />
                <SelectInput
                  ...
                  onChangeSelect={(value) => setPack(value)}
                  items={currentPack}
                />
                <Input
                  label="IUC Number"
                  ...
                  value={iucNumber}
                  handleChange={(number) => setIucNumber(number)}
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    handlePayCable(biller, pack, iucNumber, number)
                  }
                >
